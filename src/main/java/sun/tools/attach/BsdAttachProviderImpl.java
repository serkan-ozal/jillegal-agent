...
public class BsdAttachProviderImpl extends HotSpotAttachProvider {
        ...
        throws AttachNotSupportedException, IOException
    {
        ...
        return new BsdVirtualMachineImpl(this, vmid);
    }
        ...
        throws AttachNotSupportedException, IOException
    {
        ...
        if (vmd instanceof HotSpotVirtualMachineDescriptor) {
            ...
            checkAttachPermission();
            return new BsdVirtualMachineImpl(this, vmd.id());
        } else {

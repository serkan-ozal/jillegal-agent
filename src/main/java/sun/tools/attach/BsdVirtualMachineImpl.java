 ...
 */
public class BsdVirtualMachineImpl extends HotSpotVirtualMachine {
     ...
     */
    public BsdVirtualMachineImpl(AttachProvider provider, String vmid)
    ...
    private class SocketInputStream extends InputStream {
        ...
        public synchronized int read(byte[] bs, int off, int len) throws IOException {
            ...
            return BsdVirtualMachineImpl.read(s, bs, off, len);
        }

        public void close() throws IOException {
            BsdVirtualMachineImpl.close(s);
        }
    }
    ...
    private void writeString(int fd, String s) throws IOException {
        if (s.length() > 0) {
            ...
            BsdVirtualMachineImpl.write(fd, b, 0, b.length);
        }
        byte b[] = new byte[1];
        b[0] = 0;
        write(fd, b, 0, 1);

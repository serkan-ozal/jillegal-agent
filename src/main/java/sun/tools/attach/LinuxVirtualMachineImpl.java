...
public class LinuxVirtualMachineImpl extends HotSpotVirtualMachine {
     ...
     */
    LinuxVirtualMachineImpl(AttachProvider provider, String vmid)
    ...
    private class SocketInputStream extends InputStream {
        ...
        public synchronized int read(byte[] bs, int off, int len) throws IOException {
            ...
            return LinuxVirtualMachineImpl.read(s, bs, off, len);
        }

        public void close() throws IOException {
            LinuxVirtualMachineImpl.close(s);
        }
    }
    ...
    private void writeString(int fd, String s) throws IOException {
        if (s.length() > 0) {
            ...
            LinuxVirtualMachineImpl.write(fd, b, 0, b.length);
        }
        byte b[] = new byte[1];
        b[0] = 0;
        write(fd, b, 0, 1);

...
public class WindowsVirtualMachineImpl extends HotSpotVirtualMachine {
    ...
    WindowsVirtualMachineImpl(AttachProvider provider, String id)
    ...
    private class PipedInputStream extends InputStream {
        ...
        public synchronized int read(byte[] bs, int off, int len) throws IOException {
            ...
            return WindowsVirtualMachineImpl.readPipe(hPipe, bs, off, len);
        }

        public void close() throws IOException {
            if (hPipe != -1) {
                WindowsVirtualMachineImpl.closePipe(hPipe);
                hPipe = -1;
           }
        }
    }

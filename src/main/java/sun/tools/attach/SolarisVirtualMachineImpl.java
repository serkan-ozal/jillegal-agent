 ...
 */
public class SolarisVirtualMachineImpl extends HotSpotVirtualMachine {
     ...
     */
    SolarisVirtualMachineImpl(AttachProvider provider, String vmid)
    ...
    private class SocketInputStream extends InputStream {
        ...
        public synchronized int read(byte[] bs, int off, int len) throws IOException {
            ...
            return SolarisVirtualMachineImpl.read(s, bs, off, len);
        }

        public void close() throws IOException {
            SolarisVirtualMachineImpl.close(s);
        }
    }

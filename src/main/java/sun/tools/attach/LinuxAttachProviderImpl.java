...
public class LinuxAttachProviderImpl extends HotSpotAttachProvider {
        ...
        throws AttachNotSupportedException, IOException
    {
        ...
        return new LinuxVirtualMachineImpl(this, vmid);
    }
        ...
        throws AttachNotSupportedException, IOException
    {
        ...
        if (vmd instanceof HotSpotVirtualMachineDescriptor) {
            ...
            checkAttachPermission();
            return new LinuxVirtualMachineImpl(this, vmd.id());
        } else {
